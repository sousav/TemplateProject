...
CppLibrary::CppLibrary(): ACreator("CppLibrary") {
...
ArgParser::parser CppLibrary::setupArgParser() const {
...
bool CppLibrary::checkArgument(ArgParser::parser_results const &args) const {
    // expect no other argument
    return true;
}

std::unordered_map<std::string, std::string> CppLibrary::setupProjectKeyword(ArgParser::parser_results const &args) const {
